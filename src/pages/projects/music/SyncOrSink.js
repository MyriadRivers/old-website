...
const SyncOrSink = () => {
  return (
    <div>
      <Subtitle title={"SYNC OR SINK"} subtitle={"June 2017 - December 2019"}/>
      <br />
      ...
      Sean Choi, Alice Hayes, Angie Chen, and Catherine Sun, developed in Unity using C#. You can download a version 
      <a href="https://amarantgames.itch.io/sync-or-sink-dreamhack-demo"> here</a>!
      <br />
      <br />
